...
Automatically check and install missing dependencies in both backend and frontend.
Boot up the Node Express server on http://localhost:5000.
Boot up the Vite dev server on http://localhost:5173.
Open the web app automatically in your default browser.
...
First Contribution - Earned for the first accepted volunteer application or submitted donor request response.
First Blood Donation - Awarded upon coordinating/submitting a donor offer for emergency blood requests.
